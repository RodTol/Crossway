...
public class Coordinates {
    ...
    Coordinates getDiagonalNeighbour(Direction direction) throws RuntimeException {
        switch (direction) {
            case NORTH_WEST: {
    ...
    Coordinates getVerticalNeighbour(Direction direction) throws RuntimeException {
        switch (direction) {
            case NORTH_WEST:
            case NORTH_EAST: {
    ...
    Coordinates getHorizontalNeighbour(Direction direction) throws RuntimeException {
        switch (direction) {
            case NORTH_WEST:
            case SOUTH_WEST: {
