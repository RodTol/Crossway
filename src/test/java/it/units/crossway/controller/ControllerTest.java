...
public class ControllerTest {
    ...
    @Test void canPlace() {   // I need to test that can place is called and it outputs correct result
        ...
        Mockito.verify(board).canPlace(Mockito.any(), Mockito.any());  // it verifies board.canPlace has been called once
